    ...
    <div class="container">
        <div class="main-footer__top">
            <a href="index.html" class="main-footer__logo">
                <img src="{{ asset('admin/assets/images/Unipath.png') }}" width="135" alt="Eduhive HTML Template">
            </a><!-- /.main-footer__logo -->
        ...
        <div class="row gutter-y-40">
            <div class="col-xl-3 col-lg-4 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                <div class="footer-widget footer-widget--about">
                    ...
                    <p class="footer-widget__about-text">Unipath adalah platform belajar bagi orang-orang yang berminat kuliah dan mencari beasiswa .</p><!-- /.footer-widget__about-text -->
