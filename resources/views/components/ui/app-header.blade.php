<header id="header-sticky"
    class="main-header main-header--two main-header--three sticky-header--three sticky-header--normal">
    <div class="container-fluid">
        <div class="main-header__inner">
            <div class="main-header__left">
                <div class="main-header__logo logo-retina">
                    <a href="index.html">
                        <img src="{{ asset('app/images/logo-dark.png') }}" alt="eduhive HTML" width="209">
                    </a>
