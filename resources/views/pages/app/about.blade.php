            ...
            <div class="row gutter-y-60">
                <div class="col-lg-6 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                    <div class="about-two__image">
                        <img src="{{asset('app/images/about-2-1.webp')}}" alt="about image" class="about-two__image__one">
                        <img src="{{asset('app/images/about-2-2.webp')}}" alt="about image" class="about-two__image__two">
                        <img src="{{asset('app/images/shapes/about-shape-2-1.png')}}" alt="shape" class="about-two__image__shape-one">
                ...
                <div class="col-lg-6">
                    <div class="about-two__content">
                        <div class="sec-title wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                            ...
                            <h3 class="sec-title__title">Pelajari Skill <span class="">Untuk Satu Langkah</span> <br> Lebih <span class="sec-title__title__text">Maju</span></h3>
                        </div>
                        <div class="about-two__description wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                            <p class="about-two__text">Unipath hadir sebagai solusi untuk kalian yang ingin mendalami kuliah lebih lanjut berbagai materi sesuai peminatan anda ada di sini semua di ajarkan dengan Instructor yang expert di bidangnya.</p>
                        </div>
                        <div class="about-two__row row">
                            ...
                            <div class="col-sm-6 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                                <div class="about-two__info">
                                    ...
                                    <h4 class="about-two__info__title">Expert mentors</h4>
                                </div>
                            </div>
                            <div class="col-sm-6 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="100ms">
                                <div class="about-two__info">
                                    ...
                                    <h4 class="about-two__info__title">Lifetime Access</h4>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="testimonials-three section-space2" id="testimonials">
        ...
        <div class="container">
            <div class="sec-title sec-title--center wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                ...
                <h3 class="sec-title__title">Kata <span class="sec-title__title__text">orang tentang</span> Unipath</h3>
            </div>
        ...
        "responsive":{
            ...
            "1200":{
                ...
                <div class="item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                    <div class="testimonial-card-three">
                        <div class="testimonial-card-three__image">
                            <img src="{{asset('app/images/testimonial-3-1.webp')}}" alt="Michael G. Ware">
                        </div>
                        <div class="testimonial-card-three__content">
                            ...
                            <p class="testimonial-card-three__quote">Unipath sangat membantu untuk para anak yang ingin kuliah dan harga kelasnya pun sangat murah</p>
                ...
                <div class="item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <div class="testimonial-card-three">
                        <div class="testimonial-card-three__image">
                            <img src="{{asset('app/images/testimonial-3-2.webp')}}" alt="Sarah Albert">
                        </div>
                        <div class="testimonial-card-three__content">
                            <div class="testimonial-card-three__icon">
                                <span class="icon-quote"></span>
                            ...
                            <p class="testimonial-card-three__quote">Kelas/Course yang tersedia di unipath sangat fleksible dan bisa di akses dimana saja untuk di pelajari materinya juga mudah untuk di serap.</p>
                            <div class="eduhive-ratings">
                                <span class="eduhive-ratings__icon">
                                    <i class="fa fa-star"></i>
                                </span>
                ...
                <div class="item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                    <div class="testimonial-card-three">
                        <div class="testimonial-card-three__image">
                            <img src="{{asset('app/images/testimonial-3-3.webp')}}" alt="Kevin Martin">
                        </div>
                        <div class="testimonial-card-three__content">
                            <div class="testimonial-card-three__icon">
                                <span class="icon-quote"></span>
                            ...
                            <p class="testimonial-card-three__quote">Unipath sangat bagus untuk anak anak yang mau mendalami materi kuliah sesuai peminatan.</p>
                            <div class="eduhive-ratings">
                                <span class="eduhive-ratings__icon">
                                    <i class="fa fa-star"></i>
                                </span>
        ...
        <img src="{{asset('app/images/shapes/about-shape-3-1.png')}}" alt="shape" class="testimonials-three__shape-one">
        <img src="{{asset('app/images/shapes/about-shape-3-2.png')}}" alt="shape" class="testimonials-three__shape-two">
        <img src="{{asset('app/images/shapes/about-shape-3-3.png')}}" alt="shape" class="testimonials-three__shape-three">
